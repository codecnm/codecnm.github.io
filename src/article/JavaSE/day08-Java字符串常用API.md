...
![01](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/01.png)

- 找到索引选项卡中的输入框

![02](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/02.png)

- 在输入框中输入Random

![03](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/03.png)

- 看类在哪个包下

![04](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/04.png)

- 看类的描述

![05](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/05.png)

- 看构造方法

![06](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/06.png)

- 看成员方法

![07](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/07.png)
...
> **<span style="color: red">注意：字符串的内容是不会发生改变的，它的对象在创建后不能被更改</span>**
...
- 常用的构造方法
  ...
  | public String(byte[] bys)      | 根据字节数组的内容，来创建字符串对象  <span style="color :red">应用场景：网络中传输的数据都是以字节的形式进行传输的</span> |
...
> **注意：StringBuilder在打印其对象时，打印的是属性值（因为Java在底层对其做了一些特殊处理）**

### 3.2 链式编程

> **方法返回的是自身对象，可以直接去调用自身其他的方法**
