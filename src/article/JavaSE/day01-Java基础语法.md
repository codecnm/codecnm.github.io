...
解惑：cmd默认操作C盘下的users文件夹下的XXX文件夹。（XXX就是计算机名）
 ![image-20210923091350952](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/cmd.png)
...
![image-20210923091350952](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/1.png)

第二步：点击高级系统设置。

​	 ![image-20210923091350952](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/2.png)

第三步：选择高级，再点击下面的环境变量。

 ![image-20210923091350952](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/3.png)



第四步：找系统变量里面的PATH

 ![image-20210923091350952](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/4.png)
...
移动的好处：在CMD中打开软件时，会先找当前路径，再找环境变量，在环境变量中是从上往下依次查找的，如果路径放在最上面查找的速度比较快。
 ...
 ![image-20210923091350952](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/5.png)
...
![image-20210923091654365](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/image-20210923091654365.png)
...
![image-20210923091710450](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/image-20210923091710450.png)

②**Path**：告诉操作系统JDK提供的javac(编译)、java(执行)命令安装到了哪个位置

![image-20210923091721035](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/image-20210923091721035.png)
...
![image-20210923091350952](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/image-20210923091350952.png)

### 1.10 JRE和JDK

![image-20210923091544110](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/image-20210923091544110.png)
...
> 1. JDK是什么？有哪些内容组成？
>
> JDK是Java的开发工具包，主要包含以下三个部分：
>
> - JVM虚拟机：Java程序真正运行的地方
> - 核心类库：Java已经写好的东西，我们可以直接使用的
> - 开发工具：javac、java、jdb、jhat
>
> 2. JRE是什么？有哪些不容组成？
>
> JRE是Java的运行环境，主要包含以下三个部分：
>
> - JVM
> - 核心类库
> - 运行工具
