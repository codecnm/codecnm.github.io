...
![1545615769372](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/1545615769372.png)
...
![1545616039363](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/1545616039363.png)
...
1. 大括号的开头可以另起一行书写，但是还是建议写在第一行的末尾
2. 如果我们要对一个布尔类型的变量进行判断，不要写 ==，直接把变量写在小括号中即可。
3. 如果大括号中的语句体只有一条，那么大括号可以省略不写，如果大括号省略了，那么if只能控制距离他最近的那一条语句。
...
![1545616221283](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/1545616221283.png)
...
在实际开发中，电影院选座也会使用到if判断。假设某影院售卖了100张票，票的序号为1~100。其中奇数票号坐左侧，偶数票号坐右侧。
...
![1545616667104](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/1545616667104.png)
