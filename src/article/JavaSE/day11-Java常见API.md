...
查看API文档，我们可以看到API文档中关于Math类的定义如下：
 ...
 ![1576047659085](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/1576047659085.png) 
...
![1576047846672](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/1576047846672.png) 
...
查看API文档，我们可以看到API文档中关于System类的定义如下：
 ...
 ![1576049347968](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/1576049347968.png) 
...
![1576049535584](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/1576049535584.png) 
...
​	任意一个按钮被点击之后，上方了按钮出现。当点击上方按钮之后取消关机任务
 ...
 ![恶搞好基友](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/%E6%81%B6%E6%90%9E%E5%A5%BD%E5%9F%BA%E5%8F%8B.png)
...
![1576053677194](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/1576053677194.png) 
...
![1576053871503](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/1576053871503.png) 
...
![1576055135105](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/1576055135105.png) 

2. 选择toString，此时会弹出如下的对话框

![1576055198877](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/1576055198877.png) 
...
1. 在空白处使用快捷键：alt + insert。此时会弹出如下的对话框
 ...
 ![1576056718392](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/1576056718392.png) 

2. 选择equals() and hashCode()方法，此时会弹出如下的对话框

![1576057779458](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/1576057779458.png) 

点击next，会弹出如下对话框：

![1576057813175](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/1576057813175.png) 

选择neme和age属性点击next，此时就会弹出如下对话框：

![1576057892814](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/1576057892814.png) 
...
![浅克隆](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/%E6%B5%85%E5%85%8B%E9%9A%86.png)

**深克隆：**

​	基本数据类型拷贝过来，字符串复用，引用数据类型会重新创建新的

![深克隆](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/%E6%B7%B1%E5%85%8B%E9%9A%86.png)
...
![1576058492444](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/1576058492444.png) 
...
![1576058659628](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/1576058659628.png) 
...
查看API文档，我们可以看到API文档中关于BigInteger类的定义如下：
 ...
 ![Snipaste_2022-09-04_21-36-01](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/Snipaste_2022-09-04_21-36-01.png)
...
![bigInteger的底层原理](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/bigInteger%E7%9A%84%E5%BA%95%E5%B1%82%E5%8E%9F%E7%90%86.png)
...
查看API文档，我们可以看到API文档中关于BigDecimal类的定义如下：
 ...
 ![1576132679789](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/1576132679789.png)
...
要用BigDecimal类，那么就需要首先学习一下如何去创建BigDecimal的对象。通过查看API文档，我们可以发现Jdk中针对BigDecimal类提供了很多的构造方法，但是最常用的构造方法是：
 ...
 ![1576134383441](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/1576134383441.png)
...
把数据看成字符串，遍历得到里面的每一个字符，把这些字符在ASCII码表上的值，都存储到数组中。
 ...
 ![bigdecimal存储原理](https://blog-codecnm-cn.oss-cn-chengdu.aliyuncs.com/blog/bigdecimal%E5%AD%98%E5%82%A8%E5%8E%9F%E7%90%86.png)
